...
def get_split(dataset, n_features):
    ...
    for index in features:                    # 在 n_features 个特征中选出最优的特征索引，并没有遍历所有特征，从而保证了每课决策树的差异性
        for row in dataset:
            # 针对某个特征计算时，对于该特征的每个值row[index]都计算一次GINI系数
            # test_split中仍是一个循环，找出数据集中大于row[index]和小于row[index]的列表
...
def random_forest(train, test, max_depth, min_size, sample_size, n_trees, n_features):
    ...
    for i in range(n_trees):
        # 随机抽样的训练样本， 随机采样保证了每棵决策树训练集的差异性，有放回的采样
...
# Trees: 1
# Scores: [76.19047619047619, 83.33333333333334, 69.04761904761905, 78.57142857142857, 80.95238095238095]
...
# random= 0.13436424411240122
# Trees: 20
# Scores: [83.33333333333334, 88.09523809523809, 80.95238095238095, 90.47619047619048, 85.71428571428571]
# Mean Accuracy: 85.714%
